...
public class E11_13 {
	public static void main(String args[]) throws Exception {
		...
		TreeMap rank = new TreeMap (new Comparator() { //TreeMap의 정렬기준을 맞춰주는것 -> firstKey를 살리기 위해.
		...
		System.out.println();
		System.out.println("1위는 " + rank.firstKey() + "입니다."); //treemap은 순서대로 넣었기 때문에 firstKey를 하면 가장 먼저인 key를 설정
	}
}
